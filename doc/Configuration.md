# Configuration Guide <br/> Reviews service Microservice
...
For the microservice to work correctly, you need to declare two persistence for ratings and reviews. 
...
Example:
```yaml
- descriptor: "pip-services-reviews:persistence:memory:reviews:1.0"
  options:
    max_page_size: 100

- descriptor: "pip-services-reviews:persistence:memory:ratings:1.0"
  options:
    max_page_size: 100
```
