...
export interface IRatingsPersistence extends IGetter<RatingV1, string> {
    ...
    getOneById(correlationId: string, id: string, callback: (err: any, item: RatingV1) => void): void;
    ...
    deleteById(correlationId: string, id: string, callback: (err: any, item: RatingV1) => void): void;
}
